...
import itertools
import sqlite3
import data_store.datastore as ds
import common.aggregate_iterable as ai
...
class SQLiteTableOneToManyDataStore(ds.DataStore):
    ...
    def recreate_foreignid_index(self):
        self.connection.execute(r"CREATE INDEX IF NOT EXISTS foreignid_index ON {0} (foreign_id)".format(self.table_name))
